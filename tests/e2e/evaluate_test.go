...
func TestEvaluateEndpoint_SimpleScript(t *testing.T) {
...
func TestEvaluateEndpoint_ScriptWithPlatformAPI(t *testing.T) {
	ctx := context.Background()
...
func TestEvaluateEndpoint_ScriptError(t *testing.T) {
	ctx := context.Background()
...
func TestEvaluateEndpoint_EmptyScript(t *testing.T) {
	ctx := context.Background()
...
func TestEvaluateEndpoint_ScriptTooLong(t *testing.T) {
	ctx := context.Background()
...
func TestEvaluateEndpoint_Unauthorized(t *testing.T) {
	ctx := context.Background()
