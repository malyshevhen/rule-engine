...
class TestApiCreateRuleRequest(unittest.TestCase):
    """ApiCreateRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCreateRuleRequest:
        """Test ApiCreateRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCreateRuleRequest`
        """
        model = ApiCreateRuleRequest()
        if include_optional:
    ...
    def testApiCreateRuleRequest(self):
        """Test ApiCreateRuleRequest"""
