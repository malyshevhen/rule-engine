...
class AnalyticsTimeSeriesData(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[AnalyticsTimeSeriesPoint]] = None
    metric: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data", "metric"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AnalyticsTimeSeriesPoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
