...
class AnalyticsExecutionStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["average_latency_ms", "failed_executions", "success_rate", "successful_executions", "total_executions"]
